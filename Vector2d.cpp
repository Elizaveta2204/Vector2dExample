...
//Конструктор для создания вектора по двум его координатам
Vector2d::Vector2d(double x, double y)
{
	this->x = x;
	this->y = y;
}
//Конструктор для создания вектора по четырем параметрам
...
//Cкалярное произведение вектора на исходный
